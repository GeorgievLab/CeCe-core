...
#define CECE_FACTORY_MANAGER(...) \
    namespace cece { namespace factory { template class FactoryManager<__VA_ARGS__>; } }

/**
 * @brief Define extern factory manager specialization.
 */
#define CECE_FACTORY_MANAGER_EXTERN(...) \
    namespace cece { namespace factory { extern template class FactoryManager<__VA_ARGS__>; } }
