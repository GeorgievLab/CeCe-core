...
public:
     ...
     */
    virtual UniquePtr<Simulation> fromFile(
     ...
     * @return Pointer to created simulation.
     */
    virtual UniquePtr<Simulation> fromSource(
     ...
     * @return Source code.
     */
    virtual String toSource(const Simulation& simulation, const io::FilePath& filename = "<source>") const;
     ...
     */
    virtual UniquePtr<Simulation> fromStream(
     ...
     * @param simulation Source simulation.
     */
    virtual void toStream(io::OutStream& os, const Simulation& simulation,
